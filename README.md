...
которых снимался Киану Ривз.
   Функция movies_by_actor принимает два Movie массива, кол-во экземпляров в них и переписывает из одного в другой экземпляры с указанным значением поля main_actor (по актеру).
