Первухин Никита ET-112. Занятие 9-10. Вариант 20 (структурный массив с фильмами).
...
которых снимался Киану Ривз.
   Функция movies_by_actor принимает два Movie массива, кол-во экземпляров в них и значение поля main_actorи и переписывает из одного данного массива в другой экземпляры с указанным значением поля main_actor (по актеру).
